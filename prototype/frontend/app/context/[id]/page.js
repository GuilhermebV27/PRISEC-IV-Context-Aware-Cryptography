...
export default function ContextPage() {
  ...
  // Persist on every change so switching to Deeper Analysis and back doesn't lose anything.
            ...
            <div className="bg-[#121212] border border-white/10 rounded-2xl p-4 shadow-2xl">
              ...
              <div className="border-t border-white/10 pt-4">
                ...
                <p className="text-xs text-[#8a8a8a] leading-relaxed mb-4">
                  Benchmark the recommended cipher for real, on real hardware. This is only meaningful if this profile's specifications match the device running the test.
                </p>
