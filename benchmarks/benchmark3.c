...
* ChaCha20 -> SPECK
* SPECK -> HIGHT
* HIGHT -> RECTANGLE (bit-sliced implementation; see rectangle.h)
*
* Build:
 ...
 * instead of the scalar table-driven one, since bit-slicing is RECTANGLE's
 * own documented design rationale and consistently outperforms the scalar
 * path (see phase7_results.csv / benchmark7). */
